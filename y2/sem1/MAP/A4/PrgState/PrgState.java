...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, MyIDictionary<StringValue,BufferedReader> ft, MyIHeap<Integer,Value> h, IStmt prg){
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        fileTable = ft;
