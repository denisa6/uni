...
void addUndoElement(UndoRedoRepository* undo_redo_repo, Repository* repo) {
    ...
    undo_redo_repo->undo[undo_redo_repo->length_undo].dynamicArray.data = (Offer*)malloc(repo->dynamicArray.capacity * sizeof(Offer));
    //copy the elements
...
void addRedoElement(UndoRedoRepository* undo_redo_repo, Repository* repo) {
    ...
    //allocate space for the elements to be copied
    undo_redo_repo->redo[undo_redo_repo->length_redo].dynamicArray.data = (Offer*)malloc(repo->dynamicArray.capacity * sizeof(Offer));
    //copy the elements
    for (int index = 0; index < repo->dynamicArray.length; index++)
