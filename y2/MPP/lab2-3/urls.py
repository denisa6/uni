...
from .views import BookList, BookDetail, AuthorList, AuthorDetail, BookStoreList, BookStoreDetail, BooksByPrice, BookAuthorsDetail, BookAuthorsList, AuthorsByAvgBookPrice, BooksByNrOfBestSeller
