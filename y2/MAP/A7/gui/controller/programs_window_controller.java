...
public class programs_window_controller implements Initializable {
    ...
    public void add_programs(){
        MyListView.getItems().addAll(initExamples());
    }
    @Override
    ...
    private void displayEx(){
        ...
        MyListView.setOnMouseClicked(new EventHandler<Event>() {
            ...
            public void handle(Event mouseEvent) {
                ...
                PrgState prg = new PrgState(stk, symTbl, out, fileMap, heap, selectedPrg, PrgState.getNumberThreads());
                ...
                try{
                    ...
                    executionCtrl.setController(ctrl);
                }catch (MyException e){
